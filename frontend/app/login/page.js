...
import "./login.css"; // Split-Screen Styles
      ...
      <div className="login-visual-side">
        <div className="visual-content">
          ...
          <p className="visual-subtitle">
            แพลตฟอร์มบริหารจัดการทริปศึกษาดูงานและฝึกงาน 
            ก้าวสู่ความเป็นมืออาชีพด้วยระบบที่ชาญฉลาดและทันสมัยที่สุด
          </p>
        </div>
        
        <div className="visual-footer">
          UTCC-TP Administrative Portal · v4.0.0
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="field-group">
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
                ...
                <Link href="/forgot" style={{ fontSize: "12px", color: "var(--primary)", fontWeight: "700", textDecoration: "none" }}>
                  ลืมรหัสผ่าน?
                </Link>
              </div>
            ...
            <button type="submit" className="btn-submit" disabled={loading || !username || !password}>
              {loading ? (
                ...
                <>เข้าสู่ระบบ <i className="fas fa-arrow-right"></i></>
              )}
            </button>
          </form>
          ...
          <div className="demo-box">
            ...
            <div className="demo-grid-new">
              {DEMO_USERS.map((u) => (
                ...
                >
                  <div className="demo-btn-icon" style={{ background: `${u.color}15`, color: u.color }}>
